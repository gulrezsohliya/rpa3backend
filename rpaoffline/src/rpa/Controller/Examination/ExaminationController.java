package rpa.Controller.Examination;
...
public class ExaminationController {
	...
	public ResponseEntity<List<Advertisement>> listAdvertisements(HttpServletRequest req) {
		try {
			return ResponseEntity.accepted().body(ES.listAdvertisements(
					((User) req.getSession().getAttribute("user")).getOfficecode(),
					((User) req.getSession().getAttribute("user")).getUsercode()));
		} catch (Exception e) {
