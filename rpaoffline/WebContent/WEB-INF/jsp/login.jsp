        ...
        <div class='containerBody' style="background: none">
            ...
            <div class="pagewrap" style="">
                <form class="form" id="loginForm" name='f' action='/estate/login' method='POST' onsubmit='return beforeSubmit();' autocomplete="off">
                    ...
                    <div class="container">
                        <input class="container__input" type="text" id="username" name="username" value="" autocomplete="off" required>
                        <label id="userLabel" for="username" class="container__label">Username</label>
                    </div>
                    <div class="container">
                        <input class="container__input" type="password" id="password" name="password" value="" autocomplete="off" required>
